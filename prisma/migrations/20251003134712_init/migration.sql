-- CreateEnum
CREATE TYPE "public"."Role" AS ENUM ('ADMIN', 'CHEF', 'CUSTOMER');
...
-- CreateIndex
CREATE INDEX "Order_chef_id_idx" ON "public"."Order"("chef_id");

-- AddForeignKey
ALTER TABLE "public"."MenuItem" ADD CONSTRAINT "MenuItem_chef_id_fkey" FOREIGN KEY ("chef_id") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Order" ADD CONSTRAINT "Order_chef_id_fkey" FOREIGN KEY ("chef_id") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
